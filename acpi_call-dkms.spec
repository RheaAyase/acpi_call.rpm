...
Source:     https://github.com/RheaAyase/acpi_call.rpm/archive/refs/heads/main.tar.gz
...
%install
install -D -m 0644 %{srcname}/*.c -t "%{buildroot}%{_usrsrc}/%{srcname}/"
install -m 0644 Makefile "%{buildroot}%{_usrsrc}/%{srcname}/"
install -m 0644 dkms.conf "%{buildroot}%{_usrsrc}/%{srcname}/"
...
%postun
rm -rfv %{_sharedstatedir}/dkms/${srcname}
rm -rfv %{_usrsrc}/%{srcname}/*

%files
%{_usrsrc}/%{srcname}/%{srcname}.c
%{_usrsrc}/%{srcname}/Makefile
%{_usrsrc}/%{srcname}/dkms.conf
